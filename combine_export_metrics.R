...
metrics <- CJ(iter = 1:25, trait = c(physical_traits, economic_traits), crop_cycle = c('Plant_Cane_2017', 'Ratoon_1_2018', 'Ratoon_2_2019'))
...
fwrite(metrics, 'project/metrics_13jan2022.csv')