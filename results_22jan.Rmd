...
**edit 24 January**: Fixed bug where diameter was left out for ratoon crops. Also make plots of the correlation coefficient `r`.
...
The following plots show a different metric of model performance: the correlation coefficient `r` between the observed and predicted values. 
